/**
 * review-pack-v2.spec.ts — Fixture-dependent tests for specific review pack states.
 *
 * Requires fixture HTML files generated by generate_fixtures.py.
 * Tests specific data values, status variants (READY/GAP/BLOCKED/NOFACTORY),
 * and fixture-specific behavior.
 *
 * Run: npx playwright test e2e/review-pack-v2.spec.ts
 * Prerequisite: python3 e2e/generate_fixtures.py
 */
...
const fixturesExist = fs.existsSync('/tmp/pr26_review_pack_v2_ready.html');
test.skip(!fixturesExist, 'Fixture files not generated — run generate_fixtures.py first');
...
// Banner Removal moved to pack-validation.spec.ts (live pack tests)
